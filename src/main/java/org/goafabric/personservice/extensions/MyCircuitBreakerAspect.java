...
//@Aspect
//@Component
//@RegisterReflection(classes = MyCircuitBreakerAspect.class, memberCategories = MemberCategory.INVOKE_DECLARED_METHODS)
//public class MyCircuitBreakerAspect implements Ordered {
//
//    private static final Logger logger = LoggerFactory.getLogger(io.github.resilience4j.spring6.circuitbreaker.configure.CircuitBreakerAspect.class);
//
...
//
//    public MyCircuitBreakerAspect(CircuitBreakerConfigurationProperties circuitBreakerProperties,
...
//        //System.out.println("### inside other Circuit Breaker Aspect");
//        return joinPoint.proceed();
//    }
//
//    @Pointcut(value = "@within(circuitBreaker) || @annotation(circuitBreaker)", argNames = "circuitBreaker")
//    public void matchAnnotatedClassOrMethod(MyCircuitBreaker circuitBreaker) {
//    }
//
...
//        System.out.println("### inside Circuit Breaker Aspect");
